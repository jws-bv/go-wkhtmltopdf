...
func newGlobalOptions() globalOptions {
	return globalOptions{
		...
		MarginLeft:        uintOption{option: "margin-left", value: 5, isSet: true},
		MarginRight:       uintOption{option: "margin-right", value: 5, isSet: true},
...
func newHeaderAndFooterOptions() headerAndFooterOptions {
	return headerAndFooterOptions{
		...
		FooterLine:     boolOption{option: "footer-line", value: true},
		...
		HeaderLine:     boolOption{option: "header-line", value: true},
